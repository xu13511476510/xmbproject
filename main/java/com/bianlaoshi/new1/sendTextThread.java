...
public class sendTextThread extends Thread {
    ...
    sendTextThread(int a,String phone)
    {
        yzm=a;
        this.phone=phone;
    }
    ...
    public void singleSend(String userid, String pwd,boolean isEncryptPwd)
    {
        try
        {
            // 参数类
            ...
            // 设置内容
            message.setContent("您的验证码是"+yzm+"，在3分钟内输入有效。如非本人操作请忽略此短信。");
            // 设置扩展号
            message.setExno("11");
            // 用户自定义流水编号
